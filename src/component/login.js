...
const Login = () => {
  ...
  const handleFormHover = () => {
    ...
    loginHeader.style.backgroundColor = '#217093';
    loginHeader.style.cursor = 'pointer';
  };

  const handleFormLeave = () => {
    const loginHeader = document.querySelector('.login-header');
    loginHeader.style.backgroundColor = ''; // Khôi phục màu nền mặc định
    loginHeader.style.cursor = ''; // Khôi phục kiểu con trỏ mặc định
  };
  return (
    <div className="login-container">
      <div className="img-container">
        <img
          className="image"
          src="https://i.pinimg.com/originals/2d/3c/7e/2d3c7e773ee8d672722a0732940c66dc.jpg"
          alt=""
        />
      </div>
      <div className="over-play"></div>
      <div className="login-header">I WON'T PEEK</div>
      <form className="form" onMouseEnter={handleFormHover} onMouseLeave={handleFormLeave}>
